...
sel_Funcion();																														/*el pulsador funcion es precionadoa para entrar a programacion */
	...
	ValTimeOutCom=5;																												/*tiempo inicial para ver los sensores*/
	...
	{   
			...
			if (rx_ip==0)
			{
				...
				Genera_ticket();																										/*procedimiento de imprimir el ticket de entrada*/
			...
			if (busy==0)
			{
				...
				Debug_txt_Tibbo((unsigned char *) "Recibe trama pto \r\n");					/*trama recibida pto paralelo */
